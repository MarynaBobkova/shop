package de.aittr.shop.security.sec_service;

import de.aittr.shop.domain.entity.User;
import de.aittr.shop.security.AuthInfo;
import de.aittr.shop.security.sec_dto.TokenResponseDto;
import de.aittr.shop.service.UserService;
...
public class AuthService {
    ...
    public TokenResponseDto getAccessToken(@NonNull String inboundRefreshToken) throws AuthException {
        Claims refreshClaims = tokenService.getRefreshClaims(inboundRefreshToken);
        String username = refreshClaims.getSubject();
        String savedRefreshToken = refreshStorage.get(inboundRefreshToken);

        if (savedRefreshToken.equals(savedRefreshToken) ) {
